...
CREATE TABLE iris.test (
       ...
       petal_width  float,
       class int);
INSERT INTO iris.test VALUES(6.3,2.7,4.9,1.8,2), (5.7,2.8,4.1,1.3,1), (5.0,3.0,1.6,0.2,0), (6.3,3.3,6.0,2.5,2), (5.0,3.5,1.6,0.6,0), (5.5,2.6,4.4,1.2,1), (5.7,3.0,4.2,1.2,1), (4.4,2.9,1.4,0.2,0), (4.8,3.0,1.4,0.1,0), (5.5,2.4,3.7,1.0,1);
